...
export const SITE_METADATA = {
  ...
  description: 'Track Rust compiler releases, changelogs, upcoming milestones, and stabilization PRs.',
  keywords: [
    'Rust',
    'Rust compiler',
    'Rust releases',
  ...
  icons: {
    icon: [
      { url: '/favicon/corro.svg', type: 'image/svg+xml' },
      { url: '/favicon/favicon.ico', sizes: '48x48' },
    ],
    apple: [{ url: '/favicon/corro.svg' }],
    shortcut: [{ url: '/favicon/corro.svg' }]
  },
  openGraph: {
    type: 'website',
    locale: 'en_US',
    ...
    description: 'Track Rust compiler releases, changelogs, upcoming milestones, and stabilization PRs.',
    images: [{ url: DEFAULT_OG_IMAGE, width: 1200, height: 630, alt: 'version.rs — Rust Compiler Release Tracker' }]
  },
  twitter: {
